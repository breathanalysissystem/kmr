...
share <- list(
  title = "Predicting the disease using Abnormal Exhale Breath",
  url = "http://bas.com/shiny/Predicting the disease using Abnormal Exhale Breath/",
  description = "Explore trends in disease predicted using the Abnormal Exhale breath.",
  twitter_user = "bas"
)

fluidPage(
  useShinyjs(),
  title = "Predicting the disease using the Abnormal Exhale Breath",
  
  
 # enclose the header in its own section to style it nicer
  div(id = "headerSection",
      h1("Predicting the disease using the exhaled breath level")
